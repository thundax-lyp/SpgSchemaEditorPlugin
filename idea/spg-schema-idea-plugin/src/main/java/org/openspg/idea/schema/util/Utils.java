...
public class Utils {
    ...
    public static boolean isSchemaFileType(@NotNull PsiFile file) {
        FileType fileType = file.getFileType();
        return fileType.equals(SchemaFileType.INSTANCE);
    }

    public static boolean isSchemaFileType(Project project, VirtualFile file) {
